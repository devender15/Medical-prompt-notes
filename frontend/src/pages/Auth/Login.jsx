              ...
              <div className="shadow sm:overflow-hidden sm:rounded-md  bg-gray-100">
                ...
                <div className="bg-gray-50 px-4 py-3 text-right sm:px-6 flex space-x-2 items-center">
                  ...
                  >
                    ...
                    <Link
                      to="/register"
                      className="inline-flex justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 hover:text-white"
                    >
                      Register
                    </Link>
                </div>
