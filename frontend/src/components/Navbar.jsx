                  ...
                  <div className="flex w-full space-x-4 justify-between items-center">
                    ...
                    {template?.templateDetails ? (
                      ...
                      <div className="flex space-x-2 items-center">
                        <button className="inline-flex justify-center rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                          <Link
                            to="/login"
